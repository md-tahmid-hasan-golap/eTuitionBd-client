      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div data-aos="fade-right" className="space-y-8">
          <div className="space-y-3 text-center lg:text-left">
            ...
            <p className="text-slate-500 text-sm md:text-base font-medium max-w-md mx-auto lg:mx-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-slate-50">
              <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center text-lg">
                <FaPhoneAlt />
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-slate-50 lg:flex sm:hidden">
              <div className="w-12 h-12 bg-slate-50 text-slate-600 rounded-xl flex items-center justify-center text-lg">
                <FaMapMarkerAlt />
              </div>
              <div>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
        ...
        <div data-aos="fade-left" className="relative mt-5 lg:mt-0">
          <form
            ...
            className="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-xl border border-slate-50 space-y-4 max-w-lg mx-auto"
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-black text-blue-900">Send Message</h3>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-100 focus:border-orange-500 focus:outline-none text-sm transition-all"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-100 focus:border-orange-500 focus:outline-none text-sm resize-none transition-all"
              ></textarea>
            </div>
