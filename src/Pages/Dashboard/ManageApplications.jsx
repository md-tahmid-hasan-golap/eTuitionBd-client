  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4">
      <div className="mb-10">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium mt-2">Approve or Reject tutor applications before students can see them.</p>
      </div>
          ...
          <table className="table w-full">
            ...
            <tbody className="text-sm font-medium text-slate-700 dark:text-slate-300">
              {applications.map((app) => (
                <tr key={app._id} className="border-b border-slate-50 dark:border-slate-800 hover:bg-slate-50 dark:bg-slate-800 transition-colors">
                  <td className="py-5 px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/50 text-blue-500 flex items-center justify-center">
                        <FaUserGraduate />
                      </div>
                      <div>
                  ...
                  <td className="py-5 px-6 text-center">
                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${
                      app.status === "Approved" ? "bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600" :
                      app.status === "Accepted" ? "bg-blue-50 dark:bg-blue-900/30 text-blue-600" :
                      app.status === "Rejected" ? "bg-red-50 dark:bg-red-900/30 text-red-600" :
