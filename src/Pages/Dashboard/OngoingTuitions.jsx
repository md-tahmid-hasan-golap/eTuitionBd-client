  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4">
      <div className="mb-10">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium mt-2">Manage your currently active tuitions and students.</p>
      </div>
      ...
      {isError ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tuitions.map((tuition) => (
            <div key={tuition._id} className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-6 pt-4">
                <div className="w-14 h-14 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xl font-black text-slate-600 dark:text-slate-300">
                  <FaGraduationCap />
                </div>
                <div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/50 flex items-center gap-3">
