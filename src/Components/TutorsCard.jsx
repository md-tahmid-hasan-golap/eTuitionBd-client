...
const TutorsCard = ({ tutor }) => {
  ...
  return (
    <>
      <div className="group w-full bg-white dark:bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-4 sm:p-6 shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 dark:border-slate-700 hover:border-orange-200 relative overflow-hidden h-full flex flex-col min-h-0">
        ...
        <div className="relative mb-5">
          ...
          <div className="absolute -bottom-2 -right-2 bg-white dark:bg-slate-900 p-2 rounded-xl shadow-md border border-slate-50 dark:border-slate-800">
        ...
        <div className="space-y-4 flex-grow flex flex-col">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 group-hover:bg-white dark:bg-slate-900 transition-colors">
              ...
              <div className="min-w-0">
                ...
                <p className="text-slate-700 dark:text-slate-300 font-bold text-xs break-words">
      ...
      {isOpen && (
        <div className="modal modal-open z-[9999] p-3 sm:p-4 md:p-6 items-center">
          <div className="modal-box w-full max-w-[min(100%,calc(100vw-1.5rem))] sm:max-w-lg md:max-w-2xl lg:max-w-3xl p-0 bg-white dark:bg-slate-900 shadow-2xl relative flex flex-col max-h-[min(92dvh,900px)] sm:max-h-[min(88dvh,900px)] overflow-hidden rounded-2xl sm:rounded-[2rem] md:rounded-[3rem]">
            <div className="bg-[#0f172a] p-5 sm:p-8 md:p-10 text-white relative shrink-0">
              <button
                ...
                className="btn btn-sm btn-circle bg-white/10 dark:bg-slate-800/50 hover:bg-white/20 border-none text-white absolute right-3 top-3 sm:right-5 sm:top-5 md:right-6 md:top-6 z-[100]"
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:gap-8 relative z-10 text-center sm:text-left pr-10 sm:pr-0">
                ...
                <div className="space-y-1 w-full min-w-0">
                  ...
                  <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-3 mt-3 sm:mt-4">
                    <span className="bg-white/10 dark:bg-slate-800/50 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[10px] sm:text-xs font-bold backdrop-blur-md border border-white/10">
                      {gender || "Tutor"}
                    </span>
            ...
            <div className="p-5 sm:p-6 md:p-8 lg:p-12 space-y-6 sm:space-y-8 md:space-y-10 overflow-y-auto flex-1 min-h-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                <div className="p-4 sm:p-5 md:p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl sm:rounded-[2rem] border border-slate-100 dark:border-slate-700">
                  <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center text-orange-500 shadow-sm border border-slate-100 dark:border-slate-700 shrink-0">
                      <FaGraduationCap />
                    </div>
                  ...
                  <p className="text-slate-600 dark:text-slate-300 font-medium text-sm leading-relaxed break-words">
                ...
                <div className="p-4 sm:p-5 md:p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl sm:rounded-[2rem] border border-slate-100 dark:border-slate-700">
                  <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center text-blue-500 shadow-sm border border-slate-100 dark:border-slate-700 shrink-0">
                      <FaBriefcase />
                    </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="flex items-center gap-3 sm:gap-4 bg-slate-50 dark:bg-slate-800 p-3 sm:p-4 rounded-2xl border border-slate-100 dark:border-slate-700 min-w-0">
                    <FaEnvelope className="text-slate-400 shrink-0" />

                    <span className="text-slate-700 dark:text-slate-300 font-bold text-xs sm:text-sm break-all">
                      {email || "Email Hidden"}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 bg-slate-50 dark:bg-slate-800 p-3 sm:p-4 rounded-2xl border border-slate-100 dark:border-slate-700 min-w-0">
                    ...
                    <span className="text-slate-700 dark:text-slate-300 font-bold text-xs sm:text-sm break-words">
